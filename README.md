...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 20 ms | 68 ms | 100% |
| Europe (Germany) | fireworks | 98 ms | 202 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 86 ms | 100% |
| US (Central) | google | 41 ms | 97 ms | 100% |

- Full dataset: [`data/rankings/2026-09-07.json`](data/rankings/2026-09-07.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-07T07:48:37Z — this table is regenerated daily._
