...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 18 ms | 69 ms | 100% |
| Europe (Germany) | fireworks | 98 ms | 200 ms | 100% |
| South America (São Paulo) | openrouter | 61 ms | 92 ms | 100% |
| US (Central) | fireworks | 30 ms | 85 ms | 100% |

- Full dataset: [`data/rankings/2026-09-20.json`](data/rankings/2026-09-20.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-20T07:49:33Z — this table is regenerated daily._
