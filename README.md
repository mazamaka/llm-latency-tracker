...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 15 ms | 48 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 202 ms | 100% |
| South America (São Paulo) | openrouter | 60 ms | 538 ms | 100% |
| US (Central) | google | 45 ms | 114 ms | 100% |

- Full dataset: [`data/rankings/2026-08-25.json`](data/rankings/2026-08-25.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-25T07:48:09Z — this table is regenerated daily._
