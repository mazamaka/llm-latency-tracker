...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 18 ms | 54 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 200 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 591 ms | 100% |
| US (Central) | google | 46 ms | 127 ms | 100% |

- Full dataset: [`data/rankings/2026-08-21.json`](data/rankings/2026-08-21.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-21T07:47:30Z — this table is regenerated daily._
