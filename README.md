...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 21 ms | 70 ms | 100% |
| Europe (Germany) | fireworks | 96 ms | 198 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 97 ms | 100% |
| US (Central) | google | 47 ms | 111 ms | 100% |

- Full dataset: [`data/rankings/2026-09-10.json`](data/rankings/2026-09-10.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-10T07:49:49Z — this table is regenerated daily._
