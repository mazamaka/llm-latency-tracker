...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 15 ms | 56 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 200 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 90 ms | 100% |
| US (Central) | google | 46 ms | 102 ms | 100% |

- Full dataset: [`data/rankings/2026-08-22.json`](data/rankings/2026-08-22.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-22T07:47:36Z — this table is regenerated daily._
