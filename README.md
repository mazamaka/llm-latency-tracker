...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 17 ms | 50 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 199 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 80 ms | 100% |
| US (Central) | google | 43 ms | 116 ms | 100% |

- Full dataset: [`data/rankings/2026-08-23.json`](data/rankings/2026-08-23.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-23T07:47:38Z — this table is regenerated daily._
