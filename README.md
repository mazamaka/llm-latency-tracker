...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 18 ms | 55 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 198 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 114 ms | 100% |
| US (Central) | google | 45 ms | 116 ms | 100% |

- Full dataset: [`data/rankings/2026-08-27.json`](data/rankings/2026-08-27.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-27T07:47:51Z — this table is regenerated daily._
