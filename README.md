...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 16 ms | 49 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 198 ms | 100% |
| South America (São Paulo) | openrouter | 59 ms | 129 ms | 100% |
| US (Central) | google | 47 ms | 112 ms | 100% |

- Full dataset: [`data/rankings/2026-08-26.json`](data/rankings/2026-08-26.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-26T07:47:53Z — this table is regenerated daily._
