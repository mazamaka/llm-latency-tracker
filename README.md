...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 16 ms | 50 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 199 ms | 100% |
| South America (São Paulo) | openrouter | 57 ms | 83 ms | 100% |
| US (Central) | google | 43 ms | 117 ms | 100% |

- Full dataset: [`data/rankings/2026-08-24.json`](data/rankings/2026-08-24.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-24T07:48:00Z — this table is regenerated daily._
