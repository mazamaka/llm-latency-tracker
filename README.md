...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 16 ms | 57 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 199 ms | 100% |
| South America (São Paulo) | openrouter | 61 ms | 306 ms | 100% |
| US (Central) | google | 47 ms | 114 ms | 100% |

- Full dataset: [`data/rankings/2026-08-20.json`](data/rankings/2026-08-20.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-20T07:47:26Z — this table is regenerated daily._
