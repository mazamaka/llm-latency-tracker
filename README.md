...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 18 ms | 61 ms | 100% |
| Europe (Germany) | fireworks | 97 ms | 198 ms | 100% |
| South America (São Paulo) | openrouter | 60 ms | 91 ms | 100% |
| US (Central) | google | 46 ms | 109 ms | 100% |

- Full dataset: [`data/rankings/2026-09-11.json`](data/rankings/2026-09-11.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-11T07:48:47Z — this table is regenerated daily._
