...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 21 ms | 86 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 199 ms | 100% |
| South America (São Paulo) | openrouter | 61 ms | 128 ms | 100% |
| US (Central) | fireworks | 28 ms | 81 ms | 100% |

- Full dataset: [`data/rankings/2026-09-17.json`](data/rankings/2026-09-17.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-17T07:49:11Z — this table is regenerated daily._
