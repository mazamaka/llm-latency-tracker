...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 19 ms | 56 ms | 100% |
| Europe (Germany) | fireworks | 98 ms | 199 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 91 ms | 100% |
| US (Central) | fireworks | 29 ms | 77 ms | 100% |

- Full dataset: [`data/rankings/2026-09-14.json`](data/rankings/2026-09-14.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-14T07:48:50Z — this table is regenerated daily._
