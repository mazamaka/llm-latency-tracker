...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 18 ms | 63 ms | 100% |
| Europe (Germany) | fireworks | 99 ms | 201 ms | 100% |
| South America (São Paulo) | openrouter | 58 ms | 98 ms | 100% |
| US (Central) | google | 43 ms | 107 ms | 100% |

- Full dataset: [`data/rankings/2026-09-05.json`](data/rankings/2026-09-05.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-05T07:48:42Z — this table is regenerated daily._
