...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 17 ms | 65 ms | 100% |
| Europe (Germany) | nscale | 98 ms | 198 ms | 100% |
| South America (São Paulo) | openrouter | 62 ms | 112 ms | 100% |
| US (Central) | fireworks | 30 ms | 88 ms | 100% |

- Full dataset: [`data/rankings/2026-09-19.json`](data/rankings/2026-09-19.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-09-19T07:49:23Z — this table is regenerated daily._
