...
|---|---|---|---|---|
| Asia (Tokyo) | fireworks | 17 ms | 74 ms | 100% |
| Europe (Germany) | fireworks | 97 ms | 202 ms | 100% |
| South America (São Paulo) | openrouter | 59 ms | 92 ms | 100% |
| US (Central) | google | 48 ms | 133 ms | 100% |

- Full dataset: [`data/rankings/2026-08-28.json`](data/rankings/2026-08-28.json) ([latest](data/rankings/latest.json))
...
_Snapshot generated 2026-08-28T06:46:53Z — this table is regenerated daily._
